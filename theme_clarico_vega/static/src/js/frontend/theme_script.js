...
//                    }
                    if ( (this.stickyTop < scroll) ) {
                        if ( $('.o_top_fixed_element').length ){
                            $('.te_shop_pager_top').css({ position: 'sticky', top: $('header').height(), width: window.innerWidth, padding: '0px 15px', margin: '0px -15px', 'background-color': '#FFF', 'z-index': '8'});
                        }
                        else{
                            $('.te_shop_pager_top').css({position: 'relative', top: 'initial'});
                        }
                    } else {
                        $('.te_shop_pager_top').css({ position: 'relative', top: 'initial', width: window.innerWidth, padding: '0px 15px', margin: '0px -15px', 'background-color': '#FFF', 'z-index':'8' });
                    }
                }
            }
        },
